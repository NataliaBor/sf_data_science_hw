...
Проводится исследования зависимостей в данных с помощью построения графиков. 
...
!! Большинство диаграмм сделаны в plotly, они не отображаются на github. Папка с графиками приложена: https://github.com/NataliaBor/sf_data_science_hw/tree/main/Project_1/graphs
